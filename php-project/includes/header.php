...
<nav id="navbar" class="navbar-mh">
    <div class="container-app d-flex align-items-center justify-content-between" style="height: 72px;">
        ...
        <div class="d-none d-lg-flex align-items-center gap-1">
            <a href="<?php echo url('/index.php'); ?>" class="nav-link-mh <?php echo isActive('/') ? 'active' : ''; ?>">Home</a>
            <a href="<?php echo url('/properties.php'); ?>" class="nav-link-mh <?php echo isActive('/properties.php') ? 'active' : ''; ?>">Properties</a>
            <a href="<?php echo url('/about.php'); ?>" class="nav-link-mh <?php echo isActive('/about.php') ? 'active' : ''; ?>">About</a>
            <a href="<?php echo url('/contact.php'); ?>" class="nav-link-mh <?php echo isActive('/contact.php') ? 'active' : ''; ?>">Contact</a>
        </div>
    ...
    <div id="mobileMenu" class="mobile-menu d-lg-none">
        ...
        <?php if ($user): ?>
            <a href="<?php echo e(url(dashboardUrlForRole($user['role']))); ?>" class="mobile-nav-link">Dashboard</a>
            <a href="<?php echo url('/bookings.php'); ?>" class="mobile-nav-link">My Bookings</a>
